...
//    private static final String USERS_JSON_PATH = "JSONs/Users.json";
    ...
    static public void saveUser(User user){
        try {
            ...
            JsonReader reader = new JsonReader(new FileReader("C:\\Users\\iguac\\Documents\\CODE\\Inge SW\\Trello-Clone\\estoNoEsTrello\\src\\main\\java\\com\\ingenieriadesoftware\\EstoNoEsTrello\\JSONs\\Users.json"));
//            JsonReader reader = new JsonReader(new FileReader(USERS_JSON_PATH));
            ...
            FileWriter fw = new FileWriter("C:\\Users\\iguac\\Documents\\CODE\\Inge SW\\Trello-Clone\\estoNoEsTrello\\src\\main\\java\\com\\ingenieriadesoftware\\EstoNoEsTrello\\JSONs\\Users.json");
...
//            JsonReader reader = new JsonReader(new FileReader(USERS_JSON_PATH));
    ...
    static public void deleteUser(String email) throws IOException{
        Gson gson = new GsonBuilder().registerTypeAdapter(LocalDate.class, new LocalDateAdapter()).create();
        List<User> users = gson.fromJson(new FileReader("C:\\Users\\iguac\\Documents\\CODE\\Inge SW\\Trello-Clone\\estoNoEsTrello\\src\\main\\java\\com\\ingenieriadesoftware\\EstoNoEsTrello\\JSONs\\Users.json"), new TypeToken<List<User>>() {}.getType());
//        List<User> users = gson.fromJson(new FileReader(USERS_JSON_PATH), new TypeToken<List<User>>() {}.getType());
        ...
        try (FileWriter writer = new FileWriter("C:\\Users\\iguac\\Documents\\CODE\\Inge SW\\Trello-Clone\\estoNoEsTrello\\src\\main\\java\\com\\ingenieriadesoftware\\EstoNoEsTrello\\JSONs\\Users.json")) {
