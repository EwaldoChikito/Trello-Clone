...
//            JsonReader reader = new JsonReader(new FileReader(USERS_JSON_PATH));
            ...
            FileWriter fw = new FileWriter("C://Users//2samd//Proyectos//Proyecto Software//estoNoEsTrello//src//main//resources//JSONs//Users.json");
...
//            JsonReader reader = new JsonReader(new FileReader(USERS_JSON_PATH));
    ...
    static public void deleteUser(String email) throws IOException{
        Gson gson = new GsonBuilder().registerTypeAdapter(LocalDate.class, new LocalDateAdapter()).create();
        List<User> users = gson.fromJson(new FileReader("C://Users//2samd//Proyectos//Proyecto Software//estoNoEsTrello//src//main//resources//JSONs//Users.json"), new TypeToken<List<User>>() {}.getType());
//        List<User> users = gson.fromJson(new FileReader(USERS_JSON_PATH), new TypeToken<List<User>>() {}.getType());
        ...
        try (FileWriter writer = new FileWriter("C://Users//2samd//Proyectos//Proyecto Software//estoNoEsTrello//src//main//resources//JSONs//Users.json")) {
